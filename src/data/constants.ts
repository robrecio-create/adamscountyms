export const towns = [
  { name: 'Natchez', slug: 'natchez', businesses: 0 },
  { name: 'Washington', slug: 'washington', businesses: 0 },
  { name: 'Stanton', slug: 'stanton', businesses: 0 },
  { name: 'Sibley', slug: 'sibley', businesses: 0 },
  { name: 'Kingston', slug: 'kingston', businesses: 0 },
  { name: 'Morgantown', slug: 'morgantown', businesses: 0 },
];
